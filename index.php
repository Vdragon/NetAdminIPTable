...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    ...
    -->
    <link href='/home/vdragon/Ubuntu One/Programming/Web_development/My_projects/Generic_CSS_stylesheet/Stylesheets/Generic_stylesheet.css'
           rel='stylesheet'
           type='text/css' />
    ...
    <div class='div_content'>
      ...
      <div id='ip_table'>
        <table id='ip_80_table' class='generic_table'>
          <caption>網段140.121.80.X的IP配置狀態入下：</caption>
          <thead>
            <tr>
              <th>IP位址</th>
              <th>有無被設定</th>
